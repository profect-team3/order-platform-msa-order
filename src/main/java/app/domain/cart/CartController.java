...
public class CartController {
	...
	public ApiResponse<String> updateItemInCart(@Valid @PathVariable UUID menuId,
		@Valid @PathVariable int quantity,@RequestParam Long userId) {
	...
	public ApiResponse<String> removeItemFromCart(@Valid @PathVariable UUID menuId,@RequestParam Long userId) {
